...
public class Jsr305OrderEntryFix implements IntentionAction {
  private static final Logger LOG = Logger.getInstance("#" + Jsr305OrderEntryFix.class.getName());

  @Override
  @NotNull
  public String getText() {
    return "Add jsr305.jar to classpath";
  }
